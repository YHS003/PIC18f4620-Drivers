...
# 79 "Ecu_Layer/DC_MOTOR/../../Mcal_Layer/GPIO/hal_gpio.h"
...
# 40 "Ecu_Layer/DC_MOTOR/ecu_dc_motor.h"
Std_ReturnType dc_motor_initialize(const dc_motor_t * const dc_motor);
# 49 "Ecu_Layer/DC_MOTOR/ecu_dc_motor.h"
...
# 67 "Ecu_Layer/DC_MOTOR/ecu_dc_motor.h"
...
Std_ReturnType dc_motor_initialize(const dc_motor_t * const dc_motor)
{
    ...
    if((((void*)0) == dc_motor) ||
       (((uint8)5 - 1) < dc_motor->dc_motor_pins[0].port) ||
       (((uint8)5 - 1) < dc_motor->dc_motor_pins[1].port) ||
       (((uint8)8 - 1) < dc_motor->dc_motor_pins[0].pin) ||
       (((uint8)8 - 1) < dc_motor->dc_motor_pins[1].pin))
    {
        return_value = (Std_ReturnType)0x00;
    }
    else
    {
        return_value = gpio_pin_intialize(&(dc_motor->dc_motor_pins[0]));
        return_value = gpio_pin_intialize(&(dc_motor->dc_motor_pins[1]));
    }
...
Std_ReturnType dc_motor_move_right(const dc_motor_t * const dc_motor)
{
    ...
    {
        return_value = gpio_pin_write_logic(&(dc_motor->dc_motor_pins[0]), DC_MOTOR_ON);
        return_value = gpio_pin_write_logic(&(dc_motor->dc_motor_pins[1]), DC_MOTOR_OFF);
    }
...
Std_ReturnType dc_motor_move_left(const dc_motor_t * const dc_motor)
{
    ...
    {
        return_value = gpio_pin_write_logic(&(dc_motor->dc_motor_pins[0]), DC_MOTOR_OFF);
        return_value = gpio_pin_write_logic(&(dc_motor->dc_motor_pins[1]), DC_MOTOR_ON);
    }

    return return_value;
}
# 101 "Ecu_Layer/DC_MOTOR/ecu_dc_motor.c"
Std_ReturnType dc_motor_stop(const dc_motor_t * const dc_motor)
{
    Std_ReturnType return_value = (Std_ReturnType)0x01;
